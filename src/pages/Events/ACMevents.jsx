...
const industry_day_events = [
  { title: "ACM Industry Day", data: industry_day },
  { title: "Poster Presentation", data: poster_industry },
];
  ...
  return (
    <div className="events-container">
      ...
      <div className="events-section">
        <h2 className="page-title section-title">Industry Day</h2>
        <div className="event-gallery justify-center">
          {industry_day_events.map((event) =>
